...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 overflow-x-hidden" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      >
        <div className={`inline-block bg-blue-100 mt-4 md:mt-36 text-blue-700 px-4 py-2 rounded-full text-sm font-semibold mb-6 ${mounted ? 'animate-fade-up' : 'opacity-0'}`} style={{ animationDelay: '120ms' }}>
          Built on Base ⚡
        </div>
